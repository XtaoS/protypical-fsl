...
parser.add_argument("-z","--test_lsample_num_per_class",type=int,default=11, help='5 4 3 2 1')
...
test_data = 'datasets/Houston.mat'
test_label = 'datasets/Houston_gt.mat'
...
class Network(nn.Module):
    def __init__(self):
        ...
        self.classifier = nn.Linear(in_features=8 * 5 * 5, out_features=CLASS_NUM)   #论文设置
        # self.classifier = nn.Linear(in_features=128, out_features=CLASS_NUM)    # 7
...
# flops, params = profile(Network, inputs=(torch.randn(1, 144, 9, 9),))
...
for iDataSet in range(nDataSet):
    ...
    # flops, params = profile(feature_encoder, inputs=(torch.randn(1, 144, 9, 9),))
    # flops, params = clever_format([flops, params])
    # print('# Model Params: {} FLOPs: {}'.format(params, flops))
    ...
    random_layer = models.RandomLayer([200, args.class_num], 1024)   # 论文原始设置
    # random_layer = models.RandomLayer([128, args.class_num], 1024)    # 7
    #                                         160                9
